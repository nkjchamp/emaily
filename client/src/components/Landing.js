	...
	return (
		<div style={{ textAlign: "center" }}>
			...
			<ul>
				...
				<li>
					Ignore the verification code process, and click Fill in your
					card details manually.
				</li>
				<li>Use credit card number 4242 4242 4242 4242.</li>
				<li>Add any future expiration date.</li>
				<li>Add any number for the CVC.</li>
			</ul>
			<p>
				Each Credit = One Survey to send. <br />
				Each Survey should have a Yes/No feedback question. <br />
